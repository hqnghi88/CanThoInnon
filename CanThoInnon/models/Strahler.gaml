...
global {
	...
	file river_shapefile <- file("../includes/ninhkieuRoads2.shp");
	...
	init {
		...
		write "connectivity_index: " + connectivity_index(river_network);
		
		write "connected_components_of: " + length(connected_components_of(river_network));		
		ask river {
