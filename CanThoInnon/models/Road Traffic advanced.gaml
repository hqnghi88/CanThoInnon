...
//		target <- any_location_in(road_geom);
	...
	aspect base3D {
		...
		if(final_target != nil){
			draw line(location,final_target.location);
		}
		if (breakdown) {
...
experiment experiment_3D type: gui { 
	output {
		display carte_principale type: opengl camera_pos: {956.6999,3239.5736,511.4931} camera_look_pos: {1799.5599,1836.819,-322.3095} camera_up_vector: {0.2338,0.3891,0.891}   {
